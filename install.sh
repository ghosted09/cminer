...
GITHUB_RELEASE_JSON=$(curl --silent "https://api.github.com/repos/ghosted09/cminer/releases?per_page=1" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/ghosted09/cminer/main/config.json -P ~/ccminer
